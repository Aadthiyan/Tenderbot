"""
TenderBot Global — Test UNGM TinyFish Agent
"""
import asyncio
import sys
import os
...
async def test_agent():
    print("=" * 60)
    print("TESTING UNGM TINYFISH AGENT")
    print("=" * 60)
    ...
    try:
        tenders = await run_ungm_agent(["cloud", "software development", "cyber security"])
        
        print("\n🎉 Agent Execution Complete!")
        print(f"Extracted {len(tenders)} valid structured UN tenders.\n")
