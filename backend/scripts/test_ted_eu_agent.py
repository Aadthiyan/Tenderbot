"""
TenderBot Global — Test TED EU TinyFish Agent
"""
import asyncio
import sys
import os
...
async def test_agent():
    print("=" * 60)
    print("TESTING TED EU TINYFISH AGENT")
    print("=" * 60)
    ...
    try:
        tenders = await run_ted_eu_agent(["artificial intelligence", "data", "cloud"])
        
        print("\n🎉 Agent Execution Complete!")
        print(f"Extracted {len(tenders)} valid structured EU tenders.\n")
