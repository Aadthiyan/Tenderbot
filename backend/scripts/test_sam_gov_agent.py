"""
TenderBot Global — Test SAM.gov TinyFish Agent
"""
import asyncio
import sys
import os
...
async def test_agent():
    print("=" * 60)
    print("TESTING SAM.GOV TINYFISH AGENT")
    print("=" * 60)
    ...
    try:
        tenders = await run_sam_gov_agent(["cloud", "infrastructure", "migration"])
        
        print("\n🎉 Agent Execution Complete!")
        print(f"Extracted {len(tenders)} valid structured tenders.\n")
